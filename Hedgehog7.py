...
st.caption("By Jeff Diamond (2026). Testing the Magnificent 7 against my low-volatility, dividend-compounding alternative index--the **Hedgehog 7.** Inspired by Jim Collins' book, *Good to Great*.")
